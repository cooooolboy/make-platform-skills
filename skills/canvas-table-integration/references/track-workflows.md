...
- user/department edit candidates come from the published Make App UI-Service routes `/api/make/app/users` and `/api/make/app/departments`, normalized to `userId/userName` and `departmentId/departmentName`
